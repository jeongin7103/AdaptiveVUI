...
#from torchinfo import summary
import danMtlTrt.networks.resnet50 as ResNet


N_IDENTITY = 8631 
class DAN50(nn.Module):
    def __init__(self, pretrained=True, num_head=4, num_class=2):
        ...
        resnet = ResNet.resnet50(pretrained_checkpoint_path="/home/fcsl/Desktop/VUI experiment/danMtlTrt/models/resnet50_ft_weight.pkl", num_classes=N_IDENTITY, include_top=include_top)
...
class DANfor50(nn.Module):
    def __init__(self, num_class=2,num_head=4, pretrained=True):

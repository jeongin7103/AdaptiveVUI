...
def parse_args():
    ...
    parser.add_argument('--model1', type=str, default='./models/송승민1_pair_6_18_epoch_0.993074472505656_f1_3_fold_ResNet50.pth', help='요인1 model path.')
    parser.add_argument('--model2', type=str, default='./models/송승민1_pair_7_12_epoch_1.0_f1_3_fold_ResNet50.pth', help='요인2 model path.')
...
def calctime(start,end):
    ...
    #print(timelist)
    return timelist
def main(webcam,model1,model2,dic):

    #return time list usage : [start time ... end time] list
    #timelist = calctime("20:22:58","20:23:04")
    ...
    while webcam.isOpened():
        ...
        if status:
            ...
            #factor1 = model1.pred(face.copy())
            #factor2 = model2.pred(face.copy())
            #print("요인1: ",factor1)
            #print("요인2: ",factor2)
            ...
            time.sleep(1)
#factor2 = model2.pred(img.copy())
   #factor1 = model1.pred(img.copy())
   #factor2 = model2.pred(img.copy())
